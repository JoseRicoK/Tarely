...
export default function NotesPage() {
  ...
  const handleLinkTask = async () => {
    ...
    try {
      ...
      setSelectedNote((prev) => (prev ? { ...prev, taskId: updated.taskId } : null));
      setNotes((prev) => prev.map((n) => (n.id === updated.id ? { ...n, taskId: updated.taskId } : n)));
  ...
  const handleUnlinkTask = async () => {
    ...
    try {
      ...
      setNotes((prev) => prev.map((n) => (n.id === selectedNote.id ? { ...n, taskId: null } : n)));
